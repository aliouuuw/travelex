-- Fix segment pricing in search_trips_by_segment_with_country function
-- Add proper segment pricing logic using route_template_pricing table
...
BEGIN
    ...
    SELECT 
        ...
        -- Fixed segment pricing: use route_template_pricing if available, otherwise base_price
        COALESCE(rtp.price, rt.base_price, 0)
    FROM trips t
